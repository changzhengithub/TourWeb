$(document).ready(function () {
  ...
  function secondVideoEffect(scrollH) {
    ...
    if (window.flag) {
      ...
      $('.wrapper-first .sticky-element').toggleClass('element-active-bg', scrollH >= wrapperFirstStickyTop + screenH * 0.5);
      $('.wrapper-fourth .sticky-element').toggleClass('element-active-bg', scrollH >= wrapperFourthStickyTop + screenH * 0.5);
      $('.wrapper-first .sticky-element').toggleClass('element-active-title', scrollH >= wrapperFirstStickyTop + screenH * 0.5);
      $('.wrapper-first .sticky-element').toggleClass('element-active-text', scrollH >= wrapperFirstStickyTop + screenH * 0.7);
    } else {
      $('.wrapper-first .sticky-element').toggleClass('element-active-scale', scrollH >= wrapperFirstStickyTop);
      $('.wrapper-fourth .sticky-element').toggleClass('element-active-scale', scrollH >= wrapperFourthStickyTop);
      $('.wrapper-first .sticky-element').toggleClass('element-active-bg', scrollH >= wrapperFirstStickyTop + screenH);
      $('.wrapper-fourth .sticky-element').toggleClass('element-active-bg', scrollH >= wrapperFourthStickyTop + screenH);
      $('.wrapper-first .sticky-element').toggleClass('element-active-title', scrollH >= wrapperFirstStickyTop + screenH);
      $('.wrapper-first .sticky-element').toggleClass('element-active-text', scrollH >= wrapperFirstStickyTop + screenH * 1.2);
